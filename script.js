(function () {
  ...
  Confetti.prototype.getContainerSize = function () {
    ...
    return (
      Math.floor(Math.random() * t.vars.confettiSizeRange[0]) +
      t.vars.confettiSizeRange[1] +
      "px"
    );
  };
  ...
  Confetti.prototype.getConfettiColor = function () {
    ...
    return t.vars.confettiColors[
      Math.floor(Math.random() * t.vars.confettiColors.length)
    ];
  };
  ...
  Confetti.prototype.getConfettiSpeed = function () {
    ...
    return t.vars.confettiSpeed[
      Math.floor(Math.random() * t.vars.confettiSpeed.length)
    ];
  };
  ...
  Confetti.prototype.generateConfetti = function () {
    ...
    confettiDOM === null || confettiDOM === void 0
      ? void 0
      : (_confettiDOM$classLis = confettiDOM.classList) === null ||
        _confettiDOM$classLis === void 0
      ? void 0
      : _confettiDOM$classLis.add("confetti");
    confettiDOM === null || confettiDOM === void 0
      ? void 0
      : (_confettiDOM$classLis2 = confettiDOM.classList) === null ||
        _confettiDOM$classLis2 === void 0
      ? void 0
      : _confettiDOM$classLis2.add("confetti-animation-" + confettiSpeed);
